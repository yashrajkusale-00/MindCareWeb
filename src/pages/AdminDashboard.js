...
function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        // 👉 replace with actual college name (can fetch dynamically from logged-in admin too)
        const collegeName = "I2IT";

        // If students is a subcollection:
      ...
      <main style={mainContentStyle}>
        ...
        {selectedStudent && (
          <div style={studentDetailStyle}>
            ...
            <p>Analytics: Placeholder data here...</p>
          </div>
        )}
        ...
        <p style={seeMoreStyle} onClick={() => navigate("/bookings")}>
          See More →
        </p>
      </main>
    </div>
